                ...
                <ScrollView>
                    ...
                    <View style={styles.viewBtn}>
                        <TouchableOpacity style={styles.botao} onPress={mapChange} >
                            <Text style={styles.txtBtn}><Icon name="run" color={"#000"} size={20} /> Percurso</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.botao} onPress={() => setModalCalendarVisible(true)}  >
                            <Text style={styles.txtBtn}><Icon name="calendar" color={"#000"} size={20} /> Data</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.viewBtn}>
                        ...
                        <TouchableOpacity onPress={() => setModalVisible(true)} style={styles.botao}>
                            <Text style={styles.txtBtn}><Icon name="human" color={"#000"} size={20} /> Máx 10</Text>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={pickImage} style={styles.botao}>
                            <Text style={styles.txtBtn}><Icon name="camera" color={"#000"} size={20} /> Imagem</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.viewBtn}>
                        <TouchableOpacity onPress={handleverificacampos} style={styles.botao}>
                            <Text style={styles.txtBtn}><Icon name="check" color={"#000"} size={20} /> Criar</Text>
                        </TouchableOpacity>
                    </View>
                        ...
                        >
                            <View style={styles.centeredView}>
                                <View style={styles.modalView}>
                                    ...
                                    <Pressable
                                        style={[styles.botao, styles.botao]}
                                        onPress={handleIncrease}>
                                        <Text style={styles.txtBtn} ><Icon name="plus-box" color={"#00bf63"} size={50} /></Text>
                                    </Pressable>
                                    ...
                                    <Pressable
                                        ...
                                        <Text style={styles.txtBtn} ><Icon name="minus-box" color={"#00bf63"} size={50} /></Text>
                                    </Pressable>

                                    <Pressable
                                        style={styles.botao}
                                        onPress={() => setModalVisible(!modalVisible)}>
                                        <Text style={styles.txtBtn} ><Icon name="check" color={"#000"} size={20} />Feito</Text>
                                    </Pressable>
                                </View>
                            </View>
                        </Modal>
