...
export default function Academia({ navigation }) {
  ...
  return (
    ...
    <View style={styles.container} >
        <ImageBackground style={styles.image} source={require('../img/muscle_background.jpg')} imageStyle={{ opacity: 0.4, }}>     
            <ScrollView>
                ...
                <View style={styles.viewBtn}>
                    <TouchableOpacity style={styles.botao} >
                        <Text style={styles.txtBtn}><MaterialCommunityIcons name="arm-flex" color={"#000"} size={20} /> Academias</Text>
                    </TouchableOpacity>
