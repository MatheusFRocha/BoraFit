...
export default function Futebol({ navigation }) {

  const image = { uri: './img/fut.jpg' };
  const auth = getAuth();
  ...
  return (
    ...
    <View style={styles.container} >
        <ImageBackground style={styles.image} source={require('../img/soccer_background.jpg')} imageStyle={{ opacity: 0.4, }}>     
            <ScrollView>
                ...
                <View style={styles.viewBtn}>
                    <TouchableOpacity style={styles.botao} >
                        <Text style={styles.txtBtn}><MaterialCommunityIcons name="soccer" color={"#000"} size={20} /> Locais</Text>
                    </TouchableOpacity>
